...
{
    public class RewritePlugin : BaseUnityPlugin
    {
        ...
        public void SetupConfig()
        {
            ...
            // Character Pad Displays //
            CharacterPadScale = Config.Bind("Background", "Character Display Scale", 1f, "Resizes character displays. ");
