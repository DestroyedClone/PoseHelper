...
namespace AlternateSkills.Toolbot
{
    public class ToolbotMain
    {
        public static GameObject myCharacter = Resources.Load<GameObject>("prefabs/characterbodies/ToolbotBody");
