...
namespace AlternateSkills
{
	...
	public class AllyTracker : MonoBehaviour
	{
		...
		private void Start()
		{
            ...
            friendlyTeamMask = TeamMask.none;
			friendlyTeamMask.AddTeam(teamComponent.teamIndex);
		}
		...
		{
			this.search.teamMaskFilter = friendlyTeamMask;
        ...
        public TeamMask friendlyTeamMask;
